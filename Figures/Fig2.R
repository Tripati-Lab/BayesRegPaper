...
ggsave(plot = p1, filename= here::here("Figures","Plots",'Fig2.pdf'), device= cairo_pdf, width =  15, height =  4)


jpeg(here::here("Figures","Plots",'Fig2.jpg'), 15, 4, units = "in", res=300)
print(p1)
dev.off()

ggsave(plot = p2, filename= here::here("Figures","Plots",'Fig2_NL.pdf'), device= cairo_pdf, width =  15, height =  4)


jpeg(here::here("Figures","Plots",'Fig2_NL.jpg'), 15, 4, units = "in", res=300)
print(p2)
dev.off()
